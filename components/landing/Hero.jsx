            ...
            >
                <div>
                    <div className="space-y-5 max-w-3xl mx-auto text-center">
                        ...
                        >
                        Empowering You in the World of AI and Machine Learning
                        </h1>
                        <p className="max-w-xl mx-auto text-gray-300">
                        Unleash Your Potential and Drive Innovation with Cutting-Edge AI Solutions
                        </p>
                    ...
                    <GradientWrapper className="mt-16 justify-center sm:mt-28" wrapperClassName="max-w-2xl h-[150px] top-12 inset-0 sm:h-[300px] lg:h-[650px]">
                    <Image
                        src={HeroImg}
                        className="shadow-lg rounded-xl mx-auto"  // Add mx-auto class here
                        alt="Mailgo"
                    />
                </GradientWrapper>
                </div>
